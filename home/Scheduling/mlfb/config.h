...
/* Start the User Queue not from 7 which is default but instead from 16 */
#define USER_Q 16                                                                               /* #define USER_Q  	  ((MIN_USER_Q - MAX_USER_Q) / 2 + MAX_USER_Q) /* default (should correspond to nice 0) */
